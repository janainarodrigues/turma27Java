 ...
 * O índice de poluição aceitável varia de 0,05 até 0,25. Se o índice sobe para 0,3 as indústrias do 1º grupo são 
 * intimadas a suspenderem suas atividades, se o índice crescer para 0,4 as industrias do 1º e 2º grupo são intimadas 
...
programa
{
	...
	funcao inicio()
	{
		...
		escreva("Qual indice da poluição?")
		leia(indicePoluicao)
		se (indicePoluicao >=0.05 e indicePoluicao<=0.25){
			escreva("Poluição aceitavel")
			
		}
		se (indicePoluicao >=0.3 e indicePoluicao<=0.39){
			escreva("Suspender atividade do 1º grupo!")
		
		}
		se (indicePoluicao >=0.4 e indicePoluicao<=0.49){
			escreva("Suspender atividade do 1º e 2º grupo!")
		}
		se (indicePoluicao >=0.5){
			escreva("Paralise suas atividades!")
		}
	}
}
/* $$$ Portugol Studio $$$ 
